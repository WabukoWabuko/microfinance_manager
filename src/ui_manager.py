...
class UIManager:
    ...
    def handle_login(self):
        ...
        if success:
            if result["role"] == role:
                ...
                self.show_message("Error", "Invalid role",
    ...
    def apply_theme(self):
        ...
        self.main_ui.statusbar.setStyleSheet(
            "background: #343A40; color: #FFFFFF;" if self.theme == "light" else "background: #212529; color: #FFFFFF;")
        self.main_ui.menubar.setStyleSheet(
            "background: #343A40; color: #FFFFFF;" if self.theme == "light" else "background: #212529; color: #FFFFFF;")
        self.db.execute(
            "INSERT OR REPLACE INTO Settings (id, theme, last_sync_timestamp) VALUES (1, ?, NULL)", (self.theme,))
    ...
    def show_message(self, title, message, icon):
        ...
        msg.setText(message)
        msg.setIcon(icon)
        msg.setStyleSheet("background: #F8F9FA; color: #000000; font-family: Roboto;" if self.theme ==
                          "light" else "background: #343A40; color: #FFFFFF; font-family: Roboto;")
        # Animate message box
